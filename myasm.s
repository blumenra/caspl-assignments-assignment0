...
;;;;;;;;;;;;;;;; FUNCTION EFFECTIVE CODE STARTS HERE ;;;;;;;;;;;;;;;; 
    ...
    first_check:
        cmp byte [ecx], 41h     ; cheack if greater or eq to 'A' (0x41)
    ...
    second_check:
        cmp byte [ecx], 5bh     ; cheack if greater or eq to 'Z' (0x5b)
    ...
    third_check:
        cmp byte [ecx], 61h     ; cheack if greater or eq to 'a' (0x61)
    ...
    forth_check:
        cmp byte [ecx], 7ah     ; cheack if !SMALLER! or eq to 'z' (0x7a)
